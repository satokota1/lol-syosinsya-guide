      ...
      <div className="container mx-auto px-4 text-left">
        {!courseType && (
          <>
            ...
            <h2>コースの選び方とこのサイトについて！！</h2>
            <p>のんびりコース⇒ゲームだしそんな真面目に勉強とかせずにのんびりやりたいよね～って人向け。目標レートはゴールドくらい。</p>
            <p>やる気コース⇒勝つためなら頑張れます！！という人向け。これ全部知ったうえで練習ちゃんとしたら誰でもマスターくらいは行けるよねって情報を詰め込んでいるつもり。</p>
            <p>※主題はマスターくらいまで行けるかどうかであり、LoL博士になることではないことに注意。細かい情報を知りたい人はLoLWikiとかでちゃんと調べてね。</p>
          </>
        )}
        {courseType && (
          <div className="mt-8">
